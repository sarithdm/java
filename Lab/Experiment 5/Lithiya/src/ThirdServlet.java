...
public class ThirdServlet extends HttpServlet{
	public void doPost(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
	{
		...
		try {
			...
			rs = stmt.executeQuery("SELECT * FROM exam where Qnumber='"+number+"' and Answer='"+answer3+"'");
			if(rs.next()){
			...
			out.println("<div class=\"tab\"><a href=\"fourth.html\">Next Question</a></div>");
			
		}
		else{
			RequestDispatcher rd = req.getRequestDispatcher("exam.html");
			rd.include(req, res);
			out.println("<div class=\"top\"> Correct answer is As</div>");
			out.println("<div class=\"tab\"><a href=\"fourth.html\">Next Question</a></div>");
		}
	}
